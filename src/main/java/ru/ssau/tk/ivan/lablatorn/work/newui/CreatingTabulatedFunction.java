...
public class CreatingTabulatedFunction extends JDialog {
    ...
    public CreatingTabulatedFunction(TabulatedFunctionFactory factory, Consumer<? super TabulatedFunction> callback) {
        super();
    ...
    public static void main(TabulatedFunctionFactory factory, Consumer<? super TabulatedFunction> callback) throws IOException {
        CreatingTabulatedFunction tableWindow = new CreatingTabulatedFunction(factory, callback);
